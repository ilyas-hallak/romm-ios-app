...
public struct DetailedRomSchema: Codable, JSONEncodable, Hashable {
    ...
    public init(from decoder: Decoder) throws {
        ...
        platformId = container.decodeFlexibleInt(forKey: .platformId, default: 0)
        platformSlug = container.decodeFlexibleString(forKey: .platformSlug, default: "")
        platformFsSlug = container.decodeFlexibleString(forKey: .platformFsSlug, default: "")
        platformName = ""
        ...
        fsSizeBytes = container.decodeFlexibleInt(forKey: .fsSizeBytes, default: 0)
        ...
        metadatum = (try? container.decode(RomMetadataSchema.self, forKey: .metadatum)) ?? RomMetadataSchema.empty(romId: id)
        ...
        missingFromFs = container.decodeFlexibleBool(forKey: .missingFromFs, default: false)
        siblings = container.decodeLossyArray(SiblingRomSchema.self, forKey: .siblings)
        romUser = (try? container.decode(RomUserSchema.self, forKey: .romUser)) ?? RomUserSchema.empty(romId: id)
